...
// Provider types  
export type ProviderKind = 'electricity' | 'water' | 'gas' | 'internet' | 'heating' | 'other';
...
export interface AccountsContextType {
  ...
  addServiceAccount: (propertyId: number, service: Omit<ServiceAccount, 'id' | 'property_id'>) => Promise<void>;
  updateServiceAccount: (id: number, data: Partial<ServiceAccount>) => Promise<void>;
