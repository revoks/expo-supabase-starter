			...
			<View className="p-4">
				...
				<Pressable
					onPress={() => {
						...
						// TODO: Add property details route
				...
				>
					<ThemedText className="mr-2 font-medium text-white">
						View Services
					</ThemedText>
...
export default function AccountsScreen() {
	...
	const { properties = [], getPropertyServices } = useAccounts();
	...
	const filteredProperties = useMemo(() => {
		...
		return properties.filter((property) => {
			...
			return services.some(
				(service) => service.provider?.kind === selectedServiceType,
			);
		});
				...
				<View className="items-center justify-center flex-1 p-4">
					...
					<Pressable onPress={handleRefresh}>
						<Card variant="subtle" className="p-4">
							<ThemedText className="text-accent">Try Again</ThemedText>
						</Card>
					</Pressable>
				</View>
			</ThemedView>
				...
				<Animated.View entering={FadeIn}>
					...
					<View className="mb-4">
						...
						{properties.length === 0 ? (
							<Card
								variant="elevated"
								className="items-center justify-center p-8 mb-8"
							>
								<Building2
									size={32}
									color={accentColor}
