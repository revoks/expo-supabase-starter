...
export function PaymentStatusBadge({ status, className = '' }: PaymentStatusBadgeProps) {
    ...
    switch (status) {
      ...
      default:
        return {
          ...
          iconColor: colorScheme === 'dark' ? colors.dark.mutedForeground : colors.light.mutedForeground
        };
    }
  };
  ...
  return (
    <View className={`flex-row items-center px-2 py-1 rounded-full ${config.bgColor} ${className}`}>
