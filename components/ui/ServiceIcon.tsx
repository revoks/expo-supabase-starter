import { Zap, Droplets, Flame, Wifi, Thermometer, HelpCircle } from 'lucide-react-native';
...
export function ServiceIcon({ type, size = 24, color, className = '' }: ServiceIconProps) {
   const getIcon = () => {
      switch (type) {
         case 'electricity':
